-- Job-agent tracker schema v2.11.
--
-- Changes from v2.10:
--   * opportunities table: 5 new nullable classification columns
--     (function, industry_normalized, city, ai_subtype,
--     eval_priority). The two-stage evaluator routes by
--     eval_priority at the call site (1 = AI direct to cloud,
--     2 = standard local pre-filter), and the dashboard's
--     filter UI reads city/function/industry directly instead
--     of recomputing LIKE patterns at query time.
--
...
CREATE TABLE applications (
    ...
    -- v2.9 dashboard lifecycle timestamps (Shortlist -> Prompts -> Apply):
    selected_at             TEXT,
...
INSERT INTO schema_version (version) VALUES (211);
