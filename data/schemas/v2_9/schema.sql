-- Job-agent tracker schema v2.9.
--
-- Changes from v2.8:
--   * applications table: 9 new nullable columns for the
--     Playwright Application Agent (Phase 11). resume_text +
--     cover_letter_text store the full submitted text. ats_platform
--     records which handler ran. screenshot_path / submitted_url /
--     screening_answers are the post-submit audit trail.
--     selected_at / prompt_generated_at / docs_ready_at are the
--     dashboard lifecycle timestamps (Shortlist -> Prompts -> Apply).
--
