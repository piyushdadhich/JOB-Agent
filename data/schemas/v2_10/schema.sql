-- Job-agent tracker schema v2.10.
--
-- Changes from v2.9:
--   * applications table: 2 new nullable columns for auto-prompt
--     generation (Spec 3). resume_prompt + cover_letter_prompt
--     persist the daily-run-built prompt strings so the dashboard's
--     Prompts tab can show them without rebuilding on demand.
--
...
INSERT INTO schema_version (version) VALUES (210);
