-- Job-agent tracker schema v2.8.
--
-- Changes from v2.7:
--   * outreach_drafts table (Phase 9 — Targeted Outreach Agent).
--     Cold outreach drafts generated by Gemma. Status transitions
--     (draft -> approved -> sent  OR  draft -> rejected) are
--     enforced in the tracker; the CHECK on status guards the
--     enum. NEVER auto-sent.
--
