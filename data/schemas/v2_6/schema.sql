-- Job-agent tracker schema v2.6.
--
-- Changes from v2.5:
--   * stage_decisions table: per-stage audit trail for the
--     multi-stage evaluator pipeline (Phase 6). Stage 1 (hard
--     filters), Stage 2 (Gemma role classifier), Stage 3 (skill
--     scorer) each persist their decision keyed on (opp_id,
