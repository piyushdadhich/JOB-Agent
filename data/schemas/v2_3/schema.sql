-- Job-agent tracker schema v2.3.
--
-- Changes from v2.2:
--   * opportunities.extracted_skill_ids_secondary TEXT (JSON
--     array of secondary-taxonomy skill IDs; annotation only).
--   * opportunities.secondary_taxonomy TEXT (per-row taxonomy
--     name string for the secondary column; e.g. 'esco' when
--     primary is 'lightcast').
--
-- Per architecture decision (Phase 5d Step 4): the three-signal
-- scorer reads extracted_skill_ids (primary) ONLY. Secondary is
-- for human-facing display and future Gemma-judge analysis.
--
