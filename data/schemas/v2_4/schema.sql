-- Job-agent tracker schema v2.4.
--
-- Changes from v2.3:
--   * match_scores table: per-opportunity hybrid scorer output
--     (deterministic + optional Gemma fields).
--   * skill_labels lookup table: skill_id -> human-readable
--     label, populated by the backfill script.
--
