-- Job-agent tracker schema v2.12.
--
-- Changes from v2.11:
--   * eval_decisions table: 1 new nullable column (flagged_at) set
--     when a user flags a decision as bad-match.
--   * NEW table flag_rules: patterns that auto-skip future
--     opportunities at persist time. See
--     engine/persistence/flag_rules.py for the matcher dataclass.
--
...
INSERT INTO schema_version (version) VALUES (212);
